...
function setup() {
  ...
  fight1 = createSprite(300,520);
  fight1.addImage("fight1",fightimg);
  
  cosmic1 = createSprite(300,140);
...
powercore = createSprite (300,390);
powercore.addImage ("powercore", powercoreimg);

health = 450;
strokeWeight(5)
stroke( "white")
healthbar = createSprite(300,50,health,30);
  ...
  background(BG1);  
          ...
          if (Gamestate === PLAY){
            ...
            if (powercore.isTouching (fighthitbox) ) {
              ...
              fight1.y = random(0,600);
              fight1.x = random(0,600);
...
function spawnAttack() {
  if (frameCount % 10  === 0) {
    FireBall1 = createSprite(random(0,600),0);
...
if (frameCount % 10 === 0) {
  Punches = createSprite(random(0,600),random(0,600));
